...
if __name__ == "__main__":
    ...
    # Train on SVRT-1
    current_dir = 'results/MTS_OCRAbs_LR_0_0004'
    ...
    test_df_name = f'{current_dir}/OCRAbs_test_MTS.csv'
    test_df.to_csv(test_df_name)
    
    train_df = pd.concat(train_df)
    train_df_name = f'{current_dir}/OCRAbs_train_MTS.csv'
