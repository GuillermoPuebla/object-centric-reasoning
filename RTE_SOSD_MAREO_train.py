...
if __name__ == "__main__":
    ...
    RUNS = 10 #10
    MAREO_TIME_STEPS = 6 #4

    # Train on SVRT-1
    current_dir = 'results/RTE_SOSD_MAREO'
    ...
    test_df_name = f'{current_dir}/MAREO_test_RTE_SOSD.csv'
    test_df.to_csv(test_df_name)

    train_df = pd.concat(train_df)
    train_df_name = f'{current_dir}/MAREO_train_RTE_SOSD.csv'
