...
# Test datasets
def get_ds_names_and_loaders(batch_size, normalization='imagenet'):
...
if __name__ == "__main__":
    ...
    # Train on SVRT-1
    current_dir = 'results/RMTS_ResNet50'
    ...
    test_df_name = f'{current_dir}/ResNet50_test_RMTS.csv'
    test_df.to_csv(test_df_name)

    train_df = pd.concat(train_df)
    train_df_name = f'{current_dir}/ResNet50_train_RMTS.csv'
