...
if __name__ == "__main__":
    ...
    # Train on SVRT-1
    current_dir = 'results/RMTS_SlotAttention_batch_16_lr_0_0001'
    ...
    test_df_name = f'{current_dir}/SlotAttention_test_RMTS.csv'
    test_df.to_csv(test_df_name)
    
    train_df = pd.concat(train_df)
    train_df_name = f'{current_dir}/SlotAttention_train_RMTS.csv'
