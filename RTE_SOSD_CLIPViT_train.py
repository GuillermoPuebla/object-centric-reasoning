...
def get_MTL_dataloader(batch_size, normalization='CLIPViT'):
    """
...
def get_val_dataloader(batch_size, normalization='CLIPViT'):
    """
...
if __name__ == "__main__":
    ...
    # Train on SVRT-1
    current_dir = 'results/RTE_SOSD_CLIPViT'
    ...
    test_df_name = f'{current_dir}/CLIPViT_test_RTE_SOSD.csv'
    test_df.to_csv(test_df_name)

    train_df = pd.concat(train_df)
    train_df_name = f'{current_dir}/CLIPViT_train_RTE_SOSD.csv'
